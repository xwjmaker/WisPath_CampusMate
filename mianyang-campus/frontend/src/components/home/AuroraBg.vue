...
onMounted(() => {
  ...
  ctn.appendChild(gl.canvas as HTMLElement)
  ...
  function update(t: number) {
    ...
    const elapsed = (t - startTime) * 0.01
    const timeVal = props.time ?? elapsed
    program!.uniforms.uTime.value = timeVal * props.speed * 0.1
